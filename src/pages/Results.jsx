    ...
    return (
        ...
        >
            ...
            <div className="flx flx-column flx-center">
                <article className="card-dim card-shadow-xs flx flx-column flx-center mg-top-xlg mg-btm-xlg pd-s">
                ...
                <section className={`grid grid-maxcols-3 ${styles.resultGrid} pd-top-s`}>
                    {
